...
namespace MyShop.DataEf.Migrations
{
    public partial class mig_wallet : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "ActiveCode", "Bio", "CreateDate", "Email", "IsActive", "LastModifyDate", "Mobile", "Password", "Skill", "UserAvatar", "UserName", "WebSite" },
                values: new object[] { 1, "bd49ddbe6eac4aaab65cef4998755fe5", "از سال 86 تا 95 مشغول کار طراحی برد الکترونیک و برنامه نویسی با میکرو کنترلر های AVR به زبان بیسیک و کمی تجربه کار با میکروکنترلر های ARM به زبان c بودم و از سال 95 تا 1400 به صورت کامل به کار در حوزه املاک و مستغلات برای کسب تجربه در این زمینه و شناسایی نیازهای فراوان این فیلد مشغول بودم و با شروع آموزش برنامه نویسی C# و ASP.NET CORE از ابتدای سال 1400 تصمیم به انجام پروژه ها و رفع نیازهای این شغل گرفتم.rاز شروع با برنامه نویسی C# علاقه شدیدی در این زمینه برای من ایجاد شد.", new DateTime(2021, 10, 27, 17, 35, 0, 0, DateTimeKind.Unspecified), "mohamadalizadeh989@gmail.com", true, null, "09121425058", "AHvMzibnzU/XiBqMNVTfHGGoJRDu9CglrvyJW1bDsRE9EnQm7E+mLc94t5fhOBLBvw==", "C# Programmer", "Default.jpg", "mohamadAlizadeh989", "www.digitaldevice.com" });
