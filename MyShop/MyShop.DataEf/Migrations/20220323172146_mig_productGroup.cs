    ...
    public partial class mig_productGroup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "ProductGroups",
                columns: new[] { "GroupId", "CreateDate", "GroupTitle", "IsDelete", "LastModifyDate", "ParentId" },
                values: new object[] { 1, new DateTime(2021, 10, 27, 17, 35, 0, 0, DateTimeKind.Unspecified), "گروه اصلی", false, null, null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "ActiveCode", "Bio", "CreateDate", "Email", "IsActive", "IsDelete", "LastModifyDate", "Mobile", "Password", "Skill", "UserAvatar", "UserName", "WebSite" },
                values: new object[] { 1, "ab12ba4a16b24b4c94ce70bfabec5c4e", "از سال 86 تا 95 مشغول کار طراحی برد الکترونیک و برنامه نویسی با میکرو کنترلر های AVR به زبان بیسیک و کمی تجربه کار با میکروکنترلر های ARM به زبان c بودم و از سال 95 تا 1400 به صورت کامل به کار در حوزه املاک و مستغلات برای کسب تجربه در این زمینه و شناسایی نیازهای فراوان این فیلد مشغول بودم و با شروع آموزش برنامه نویسی C# و ASP.NET CORE از ابتدای سال 1400 تصمیم به انجام پروژه ها و رفع نیازهای این شغل گرفتم.rاز شروع با برنامه نویسی C# علاقه شدیدی در این زمینه برای من ایجاد شد.", new DateTime(2021, 10, 27, 17, 35, 0, 0, DateTimeKind.Unspecified), "mohamadalizadeh989@gmail.com", true, false, null, "09121425058", "AHvMzibnzU/XiBqMNVTfHGGoJRDu9CglrvyJW1bDsRE9EnQm7E+mLc94t5fhOBLBvw==", "C# Programmer", "Default.jpg", "mohamadAlizadeh989", "www.digitaldevice.com" });
